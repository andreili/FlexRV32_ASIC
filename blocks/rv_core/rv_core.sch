...
C {devices/opin.sym} 1150 1330 0 0 {name=p16 lab=o_csr_imm_sel}
...
C {devices/opin.sym} 1150 1390 0 0 {name=p21 lab=o_csr_pc_next[31:1]}
...
C {sky130_stdcells/inv_1.sym} 140 680 0 0 {name=x100 VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
C {devices/lab_pin.sym} 180 630 2 1 {name=p30 sig_type=std_logic lab=clk_n}
C {sky130_stdcells/inv_1.sym} 140 790 0 0 {name=x102 VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
C {devices/lab_pin.sym} 180 740 0 0 {name=p35 sig_type=std_logic lab=reset_p}
C {sky130_stdcells/inv_1.sym} 220 790 0 0 {name=x103[0] VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
...
C {sky130_stdcells/inv_1.sym} 220 580 0 0 {name=x101[2] VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
C {devices/lab_pin.sym} 950 580 0 1 {name=p31 sig_type=std_logic lab=clk_p[2]}
C {sky130_stdcells/inv_1.sym} 220 630 0 0 {name=x101[1] VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
C {sky130_stdcells/inv_1.sym} 220 680 0 0 {name=x101[0] VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
...
C {sky130_stdcells/inv_1.sym} 220 740 0 0 {name=x103[1] VGND=VSS VNB=VSS VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hs__ }
