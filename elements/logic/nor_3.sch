...
N 320 310 320 370 {}
N 360 340 600 340 {}
C {devices/ipin.sym} 80 190 0 0 {name=p1 lab=A}
C {devices/opin.sym} 810 340 0 0 {name=p5 lab=NOR}
C {devices/vdd.sym} 610 160 0 0 {name=l2 lab=VCC}
...
C {devices/gnd.sym} 360 420 0 0 {name=l9 lab=VSS}
C {devices/ipin.sym} 80 250 0 0 {name=p2 lab=B}
C {devices/ipin.sym} 80 310 0 0 {name=p3 lab=C}
