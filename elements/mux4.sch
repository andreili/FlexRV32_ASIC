...
C {devices/ipin.sym} -260 270 0 0 {name=p7 lab=s3}
C {devices/ipin.sym} -140 330 0 0 {name=p8 lab=d3}
...
C {sky130_fd_pr/pfet_01v8.sym} -240 270 0 0 {name=M13
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} -120 270 0 0 {name=M14
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {devices/vdd.sym} -210 240 0 0 {name=l6 lab=VCC}
C {sky130_fd_pr/nfet_01v8.sym} -120 330 0 0 {name=M15
L=0.15
W=0.65  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} -120 390 0 0 {name=M16
L=0.15
W=0.65  
nf=1 mult=1
model=nfet_01v8
...
C {devices/gnd.sym} -100 420 0 0 {name=l7 lab=VSS}
